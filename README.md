...
<br> The Sherlock Holmes text is a relatively large one with around 500,000 characters. I decided to just create a text corpus of the first 50,000 characters. I wanted to see how the model would perform with a the smaller text sample. </br>
